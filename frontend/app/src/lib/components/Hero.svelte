...
<section id="hero" class="grid w-screen overflow-hidden">
    <div class="[ flex flex-nowrap justify-between flex-col ] [ p-6 ] [ row-span-2 xl:col-span-3 xl:col-start-2 col-span-4 ] border-x-[1px] border-gray-300 gap-4">
        <div>
...
<section id="hero-text" class="grid w-screen overflow-hidden border-y-[1px] border-gray-300">
    <div class="[ p-6 ] row-span-1 xl:col-span-3 xl:col-start-2 col-span-4 flex border-x-[1px] border-gray-300 gap-4">
        <p class="text-fluid-sm 2xl:text-fluid-lg">
...
<nav id="navigation" class="[ border-b-[1px] border-gray-300 ] grid w-screen overflow-hidden">
    ...
    <div class="xl:col-span-3 col-span-4 flex p-4 items-center justify-between xl:justify-end border-x-[1px] border-gray-300">
...
<style>
    ...
    #hero-text {
        grid-template-columns: repeat(6, 1fr);
        grid-template-rows: repeat(1, calc(100vw / 11));
    }
    #navigation {
        grid-template-columns: repeat(6, 1fr);
    }
