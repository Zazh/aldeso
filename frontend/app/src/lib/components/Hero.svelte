...
<section id="hero" class="grid w-screen overflow-hidden">
    <div class="[ flex flex-nowrap justify-between flex-col ]
    [ p-6 ]
    [ row-span-2 xl:col-span-3 xl:col-start-2 col-span-4 ]
    border-x-[1px] border-gray-300 gap-4">
        <div>
            <img src="logo.svg" alt="" class="w-[4rem] aspect-square" />
        </div>
        <div>
            <h1 class="text-fluid-6xl leading-none font-bold">
                Aluminum <br>
                Decorative <br>
                Solutions
            </h1>
    ...
    <div class="row-span-2 col-span-2 flex border-r-[1px] border-gray-300 gap-4">
        room img
    </div>
</section>

<section id="hero-text" class="grid w-screen overflow-hidden border-y-[1px] border-gray-300">
    <div class="[ p-6 ] row-span-1 xl:col-span-3 xl:col-start-2 col-span-4 flex border-x-[1px] border-gray-300 gap-4">
        <p class="text-fluid-sm leading-fluid-normal">
            Производим алюминиевые профили для скрытого <br>
            плинтуса и декоративной отделки высокого качества <br>
            Казахстанского производства
        </p>
    </div>
</section>
<section class="col-span-full">
    <nav id="navigation" class="[ border-b-[1px] border-gray-300 ] bottom-0 grid  w-screen overflow-hidden z-10 ">
        <div class="col-span-1 flex p-4 items-center">
            <NavBrand href="/" class="gap-4 flex">
                <svg width="48" height="22" viewBox="0 0 48 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 0H48V3H0V0Z" fill="black"/>
                    <path d="M0 19H48V22H0V19Z" fill="black"/>
                </svg>
                <span class="text-2xl tracking-widest font-semibold text-black">MENU</span>
            </NavBrand>
        </div>

        <div class="col-span-3 flex p-4 items-center justify-end border-x-[1px] border-gray-300">
            <button class="[ gap-1.5 inline-flex items-center justify-center ] cursor-pointer  focus-within:ring-4 focus-within:outline-hidden px-3.5 py-2.5 text-sm hover:bg-black text-black hover:text-white [ border-[1px] border-gray-300 ] focus-within:ring-gray-200 rounded-sm">
                ...
                <span class="font-bold tracking-wide uppercase">Фильтры</span>
            </button>
        </div>

        <div class="col-span-2 flex p-4 items-center justify-start border-r-[1px] border-gray-300">
            <button class="[ gap-1.5 inline-flex items-center justify-center ] cursor-pointer  focus-within:ring-4 focus-within:outline-hidden px-3.5 py-2.5 text-sm hover:bg-black text-black hover:text-white [ border-[1px] border-gray-300 ] focus-within:ring-gray-200 rounded-sm">
...
<style>
    #hero {
        ...
        grid-template-rows: repeat(2, calc(100vw / 6));
    }
    #hero-text {
        grid-template-columns: repeat(6, 1fr);
        grid-template-rows: repeat(1, calc(100vw / 10));
    }
    #navigation {
        grid-template-columns: repeat(6, 1fr);
    }
